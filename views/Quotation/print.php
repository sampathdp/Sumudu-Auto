...
if (!empty($quotation->customer_name)) {
    $customerName = $quotation->customer_name;
    if (!empty($quotation->customer_id)) {
        $customerObj = new Customer($quotation->customer_id);
        if ($customerObj->id) {
...
$quotationItems = $quotation->getItems($quotation->id);
$subtotal = $quotation->subtotal ?? 0;
$taxTotal = $quotation->tax_amount ?? 0;
$grandTotal = $quotation->total_amount ?? 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="details-grid">
            <div class="detail-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo htmlspecialchars($quotation->quotation_number); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Date:</span>
                    <span class="detail-value"><?php echo date('M d, Y', strtotime($quotation->created_at)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Valid Until:</span>
                    <span class="detail-value"><?php echo $quotation->valid_until ? date('M d, Y', strtotime($quotation->valid_until)) : 'N/A'; ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Status:</span>
                    <span class="detail-value"><?php echo ucfirst($quotation->status); ?></span>
                </div>
            </div>
        ...
        <!-- Items Table -->
        <h3 style="margin-bottom: 15px; color: <?php echo $company->theme == 'dark' ? '#2c3e50' : '#4361ee'; ?>;">Quotation Items</h3>
        ...
        <div class="totals-section">
            ...
            <div class="total-line">
                <span>Discount:</span>
                <span>- LKR <?php echo number_format($quotation->discount_amount, 2); ?></span>
            </div>
            <?php endif; ?>
