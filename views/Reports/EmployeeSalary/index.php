...
// Page title
$pageTitle = 'Employee Salary Report';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <title><?php echo APP_NAME; ?> - Employee Salary Report</title>
    ...
    <style>
        ...
        .status-unpaid { background: rgba(239, 68, 68, 0.1); color: var(--danger); }

        /* Salary Type Badges */
        .salary-type-monthly { background: rgba(99, 102, 241, 0.1); color: var(--primary); }
        .salary-type-daily { background: rgba(16, 185, 129, 0.1); color: var(--success); }
        .salary-type-commission { background: rgba(245, 158, 11, 0.1); color: var(--warning); }
...
<body>
                ...
                <div class="page-inner">
                    ...
                    <div class="page-header" style="margin-top: 70px;">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                <h1 class="page-title">
                                    <i class="fas fa-file-invoice-dollar me-2"></i>Employee Salary Report
                                </h1>
                                <p class="text-secondary mb-0">View employee payments and earnings history</p>
                            </div>
                    ...
                    <div class="filter-panel">
                        <div class="row">
                            ...
                            <!-- Employee Filter -->
                            <div class="col-md-6 col-lg-4 filter-section">
                            ...
                            <!-- Salary Type Filter -->
                            <div class="col-md-6 col-lg-4 filter-section">
                                <label class="filter-label">Salary Type</label>
                    ...
                    <div class="row mb-4" id="summaryCards">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="summary-card">
                                ...
                                <div class="summary-value" id="totalEarnings">LKR 0.00</div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="summary-card">
                                ...
                                <div class="summary-value" id="totalPaid">LKR 0.00</div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <div class="summary-card">
                                ...
                                <div class="summary-value" id="totalPending">LKR 0.00</div>
    ...
    <script src="<?php echo BASE_URL; ?>Ajax/js/employee_salary_report.js"></script>
</body>
</html>
